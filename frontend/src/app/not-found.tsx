...
export default function NotFound() {
  return (
    <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white">
      ...
      <div className="text-2xl mb-4 font-light opacity-80">Vous êtes perdu dans l'immensité de connaissance de poker...</div>
      <div className="mb-8 text-lg opacity-60">Cette page n'existe pas ou n'est plus accessible.<br/>Explorez, contemplez, ou revenez à la lumière.</div>
